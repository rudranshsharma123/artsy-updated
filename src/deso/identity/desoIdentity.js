// Now this file is where I handle DeSo identity, since the achi of the DeSo identity is quite differnt (since it uses event listener to communicate with the applicaiotn)
// Everythig is hanled by looking into the documentation.
